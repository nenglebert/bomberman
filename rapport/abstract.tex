...
diffère quelque peu. Pour diverses difficultés techniques, dues à un manque d'expérience,
la vue s'est vue fusionnée avec le controller; la vue-contrôleur vérifie les entrées de l'utilisateur ainsi que l'interface graphique, tandis que le modèle est le cœur du projet.
